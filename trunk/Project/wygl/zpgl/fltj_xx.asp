...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="30"><strong><img src="../images/1_1.gif" width="18" height="18" />&nbsp;<a onMouseOver="return hidestatus()" href="fltj.asp?Operation=lb">费用统计列表</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="../images/1_1.gif" width="18" height="18" />&nbsp;<a onMouseOver="return hidestatus()" href="fltj_xx.asp?Operation=lb">详细费用用统计列表</a>&nbsp;&nbsp;&nbsp;&nbsp;</strong></td>
  </tr>
  <tr>
    <td height="30">
	<form id="form3" name="form3" method="post" action="fltj_xx.asp" style="margin:0px">
...
%>
          ...
          <td width="69" align="right">费用类型：</td>
...
if request.Form("消费项目")<>"请选择" and request.Form("消费项目")<>""then
if request.Form("n")="请选择" and  request.Form("y")="请选择" then
sql00="select * from  user_sf_lb  where 收费项目='"&request.Form("消费项目")&"'"
else
...
sql00="select * from  user_sf_lb where 日期年='"&request.Form("n")&"' and 收费项目='"&request.Form("消费项目")&"' "
elseif request.Form("n")="请选择" and  request.Form("y")<>""then
sql00="select * from  user_sf_lb where 日期月='"&request.Form("y")&"' and 收费项目='"&request.Form("消费项目")&"' "
elseif request.QueryString("n")="" and  request.QueryString("y")<>""then
sql00="select * from  user_sf_lb where 日期月='"&request.QueryString("y")&"' and 收费项目='"&request.Form("消费项目")&"' "
elseif request.QueryString("n")<>"" and  request.QueryString("y")=""then
sql00="select * from  user_sf_lb where 日期年='"&request.QueryString("n")&"'and 收费项目='"&request.Form("消费项目")&"' "
elseif request.QueryString("n")<>"" and  request.QueryString("y")<>""then
sql00="select * from  user_sf_lb where 日期年='"&request.QueryString("n")&"'and  日期月='"&request.QueryString("y")&"'and 收费项目='"&request.Form("消费项目")&"' "
elseif request.Form("n")<>"请选择" and  request.Form("y")<>"请选择"then
sql00="select * from  user_sf_lb where 日期年='"&request.Form("n")&"'and  日期月='"&request.Form("y")&"'and 收费项目='"&request.Form("消费项目")&"' "
end if
end if
else
if request.Form("n")="请选择" and  request.Form("y")="请选择" then
sql00="select * from  user_sf_lb "
else
if request.Form("n")="" and request.QueryString("n")="" and  request.Form("y")="" and request.QueryString("y")="" then
sql00="select * from  user_sf_lb "
elseif request.Form("n")<>"" and  request.Form("y")="请选择"then
sql00="select * from  user_sf_lb where 日期年='"&request.Form("n")&"' "
elseif request.Form("n")="请选择" and  request.Form("y")<>""then
sql00="select * from  user_sf_lb where 日期月='"&request.Form("y")&"' "
elseif request.QueryString("n")="" and  request.QueryString("y")<>""then
sql00="select * from  user_sf_lb where 日期月='"&request.QueryString("y")&"' "
elseif request.QueryString("n")<>"" and  request.QueryString("y")=""then
sql00="select * from  user_sf_lb where 日期年='"&request.QueryString("n")&"' "
elseif request.QueryString("n")<>"" and  request.QueryString("y")<>""then
sql00="select * from  user_sf_lb where 日期年='"&request.QueryString("n")&"'and  日期月='"&request.QueryString("y")&"'"
elseif request.Form("n")<>"请选择" and  request.Form("y")<>"请选择"then
sql00="select * from  user_sf_lb where 日期年='"&request.Form("n")&"'and  日期月='"&request.Form("y")&"'"
end if
end if
end if
...
if zt=1 then
sql222="select * from  user_sf_lb where 合同编号='"&rs00("合同编号")&"' and 日期年='"&n&"' and 日期月='"&y&"'and 收费项目='"&rs00("收费项目")&"' "
...
%>
      ...
      <tr>
        <td height="25" colspan="9" align="left" valign="middle" style="border-bottom:1px solid #00376F; border-right:1px solid #00376F">&nbsp;总计：</td>
        <td width="64" height="25" align="center" valign="middle" style="border-bottom:1px solid #00376F; border-right:1px solid #00376F ">
<%
response.Write(""&zfy&"")
%>	</td>
