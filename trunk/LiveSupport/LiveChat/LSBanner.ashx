...
public class LSBanner : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        if(context.Request.QueryString["IconStylel"]!=null)
        {
            IconStylel = context.Request.QueryString["IconStylel"];//主动邀请样式
        }
        ...
        sb.AppendLine(string.Format("var invitePanelStyle = {0};",IconStylel));// 0,1,2主动邀请样式
