<%@ Page Language="C#" AutoEventWireup="true" Inherits="LiveSupportInstall.succeed" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="90%" border="0" cellspacing="0" cellpadding="8">
                                <tr>
                                    <td align="right">
                                        <input type="button" onclick="javascript:window.location.href='../Default.aspx';" value="进入置页面"></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
