...
<script runat="server">
    ...
    {
        //在应用程序关闭时运行的代码
        LiveSupport.BLL.Utils.Util.sysInfo.EndApplicationDate = DateTime.Now;
    }
        
    void Application_Error(object sender, EventArgs e) 
    { 
        //在出现未处理的错误时运行的代码
        LiveSupport.BLL.Utils.Util.sysInfo.ErrorDatre = DateTime.Now;
    ...
    {
        //在新会话启动时运行的代码
        LiveSupport.BLL.Utils.Util.sysInfo.StartSessionDate = DateTime.Now;
    }
    ...
    void Session_End(object sender, EventArgs e) 
    {
        ...
        LiveSupport.BLL.Utils.Util.sysInfo.EndSessionDate = DateTime.Now;
