/// <reference path="jquery-1.2.6-vsdoc.js" />
    ...
    invite_div.innerHTML = '<div style=" padding:8px 0px 0px 10px; color:#FFF; font-size:14px; height:20px;" >欢迎您来到Live Support</div><div style="font-size:15px; padding:20px 0px 0px 145px; height:75px;" >亲爱的朋友您好！<br /><br />来到Live Support有什么可以帮您的吗？</div><div  style=" padding:0px 0px 0px 230px;"><img src="' + homeUrl + '/Images/btn_ok' + invitePanelStyle + '.jpg" style="border:0px;"  onclick="javascript:acceptInvitation();"/>&nbsp;&nbsp;&nbsp;<img src="' + homeUrl + '/Images/btn_no' + invitePanelStyle + '.jpg" style="border:0px;" onclick="javascript:declineInvititation();" /></div>';
    function invitetime() {
