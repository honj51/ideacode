  ...
  {   
    ...
    {
        panel2Close();//隐藏层
        var win = window.open('http://localhost/LiveChatService/Chat.aspx?aid=4', 'chat', 'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=603,height=510');
        win.focus();
        win.opener = window;
        return ;
    }
