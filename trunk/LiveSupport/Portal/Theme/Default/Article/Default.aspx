<%@ Page Language="C#" MasterPageFile="~/Theme/Default/Master/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LeeHom.Cms.Web.BasePage.Article.Default" %>
...
<div class="page">
<div class="title"> >> <asp:Literal runat="server" ID="IDName" Text="文章中心" /></div>
