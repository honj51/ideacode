<%@ Page Language="C#" MasterPageFile="~/BasePage/Master/Default.Master" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="LeeHom.Cms.Web.BasePage.Vote.Show" Title="无标题页" %>
...
<LeeHom:LHPleaseWaitImageButton ID="btnSubmit" runat="server" 
        ...
        ImageUrl="../Theme/LHTheme/Manager/btnSubmit.png" 
        SecondBtnSrc="../Theme/LHTheme/Manager/btnCancel.png" 
