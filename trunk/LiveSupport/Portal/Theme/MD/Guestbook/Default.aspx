<%@ Page Language="C#" MasterPageFile="~/Theme/MD/Master/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LeeHom.Cms.Web.BasePage.Guestbook.Default" %>
...
<tr>
<td valign="middle" class="title" colspan="2"><label># <%#base.Floor-- %> <a href="New.aspx">[签写留言]</a></label><img src="../Theme/LHTheme/Page/GBIcon.gif" alt="" /> <%#Eval("PostTime")%></td>
</tr>
<tr>
