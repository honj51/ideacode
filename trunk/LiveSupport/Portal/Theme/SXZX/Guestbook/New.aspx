<%@ Page Language="C#" MasterPageFile="~/Theme/SXZX/Master/Default.Master" AutoEventWireup="true" CodeBehind="New.aspx.cs" Inherits="LeeHom.Cms.Web.BasePage.Guestbook.New" %>
...
<LeeHom:LHValidateImageButton ID="btnSubmit" runat="server" ImageUrl="~/Theme/LHTheme/Icon/btnSubmit.png" onclick="btnSubmit_Click" />　　　　　　　　　　　　　　　　　　<img src="../Theme/LHTheme/Icon/btnCancel.png" class="imgBtn" alt="取消" onclick="if(!_sub)Goto('Default.aspx');" />
</td>
</tr>
</table>
</asp:Content>