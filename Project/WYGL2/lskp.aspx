...
<body>
    ...
    <div id="div1" style="padding-top:10px;">
        <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
            ...
            <tr>
              <td height="30">&nbsp;&nbsp;&nbsp;用户名称：<input type="text" />&nbsp;&nbsp;&nbsp;用户编码：&nbsp;&nbsp;<input type="text" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<divn id="line">生成<input id="number" type="text" style="width:30px;"/>行 </div><button value="生成" onclick="getVal()">生成</button></td>
            </tr>
        </table>
    </div>
