<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jsqx.aspx.cs" Inherits="XiTong_jsqx" %>
...
<body>
    ...
    <script type="text/javascript" src="jsqx.js"></script>
     <script type="text/javascript">
		Ext.onReady(function(){	
			new Ext.Viewport({
				...
				frame : true,
				items : [
					new Ext.Hudongsoft.jsqxGrid({region:'center'})
				]
			});
		});
