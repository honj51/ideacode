<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gslb.aspx.cs" Inherits="ZiYuan_gslb" %>
...
<body>
    ...
    <script type="text/javascript" src="gslb.js"></script>
     <script type="text/javascript">
		Ext.onReady(function(){	
			new Ext.Viewport({
				...
				frame : true,
				items : [
					new Ext.Hudongsoft.gslbGrid({region:'center'})
				]
			});
		});
