...
%>
	...
	elseif rs01("合同开始时间_年")=year(now) then
...
<%		
	if rs01("合同开始时间_年")<year(now) then
		...
		if rssj01("录入状态")<>"已录入" then
		response.Write("<span style='color:#666666'>缴费</span>")
		else
		response.Write("<a href='jf_xq_lb.asp?id="&rs01("id")&"&ny="&rs01("合同开始时间_年")&"&yy="&ii&"&xh="&xh&"&page="&request.QueryString("page")&"'>缴费</a>")
		end if
			else
			  if rssj01("缴费状态")="未缴费" then
		response.Write("<span style='color:#666666'>查看详情</span>&nbsp;")
		...
		response.Write("<a href='jfxq.asp?id="&rs01("id")&"&ny="&rs01("合同开始时间_年")&"&yy="&ii&"&xh="&xh&"&page="&request.QueryString("page")&"'>查看详情</a>&nbsp;")
		end if
...
<%
	if i<year(now) then
			if rssj02("缴费状态")="" then
		response.Write("<span style='color:#666666'>查看详情</span>&nbsp;")
		if rssj02("录入状态")<>"已录入" then
		response.Write("<span style='color:#666666'>缴费</span>")
		else
		response.Write("<a href='jf_xq_lb.asp?id="&rs01("id")&"&ny="&i&"&yy="&j&"&xh="&xh&"&page="&request.QueryString("page")&"'>缴费</a>")
		end if
			else
			  if rssj02("缴费状态")="未缴费" then
		response.Write("<span style='color:#666666'>查看详情</span>&nbsp;")
		...
		response.Write("<a href='jfxq.asp?id="&rs01("id")&"&ny="&i&"&yy="&j&"&xh="&xh&"&page="&request.QueryString("page")&"'>查看详情</a>&nbsp;")
		end if
		response.Write("<span style='color:#666666'>缴费</span>")
				end if
			end if	
...
<%
	if rs01("合同结束时间_年")<year(now) then
			if rssj03("缴费状态")="" then
		response.Write("<span style='color:#666666'>查看详情</span>&nbsp;")
		if rssj03("录入状态")<>"已录入" then
		response.Write("<span style='color:#666666'>缴费</span>")
		else
		response.Write("<a href='jf_xq_lb.asp?id="&rs01("id")&"&ny="&rs01("合同结束时间_年")&"&yy="&k&"&xh="&xh&"&page="&request.QueryString("page")&"'>缴费</a>")
		end if
			else
			  if rssj03("缴费状态")="未缴费" then
		response.Write("<span style='color:#666666'>查看详情</span>&nbsp;")
		...
		response.Write("<a href='jfxq.asp?id="&rs01("id")&"&ny="&rs01("合同结束时间_年")&"&yy="&k&"&xh="&xh&"&page="&request.QueryString("page")&"'>查看详情</a>&nbsp;")
		end if
		response.Write("<span style='color:#666666'>缴费</span>")
				end if
			end if	
