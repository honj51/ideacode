...
if(document.form1.证件名称.value=='请选择')
	{
	 alert('请选择证件名称');
	 document.form1.证件名称.focus();
	 return false;
	}
if(document.form1.证件号码.value=='')
	{ 
	 alert("证件号码不能为空!");
	 document.form1.证件号码.focus();
	 return false;
	 }
if(document.form1.证件号码.value.length<18| document.form1.证件号码.value.length>19)
	{
	 alert('证件号码长度为18个字符');
	 document.form1.证件号码.focus();
	 return false;
...
if(document.form1.籍贯.value=='请选择')
	{
	 alert('请选择籍贯');
	 document.form1.籍贯.focus();
	 return false;
	}
...
if(document.form1.联系地址.value=='')
	{ 
	 alert("联系地址不能为空!");
	 document.form1.联系地址.focus();
	 return false;
	 }
if(document.form1.联系地址.value.length<4 | document.form1.联系地址.value.length>30)
	{
	 alert('联系地址长度4—30个字符');
	 document.form1.联系地址.focus();
	 return false;
