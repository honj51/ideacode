...
if(document.form1.role_name.value=='请选择')
	{
	 alert('请选择角色');
...
if(document.form1.de_name.value=='请选择')
	{
	 alert('请选择部门');
	 document.form1.de_name.focus();
	 return false;
	}
if(document.form1.birthday_y.value=='请选择')
	{
	 alert('请选择生日—年');
	 document.form1.de_name.focus();
	 return false;
	}
if(document.form1.birthday_m.value=='请选择')
	{
	 alert('请选择生日—月');
	 document.form1.de_name.focus();
	 return false;
	}
if(document.form1.birthday_d.value=='请选择')
	{
	 alert('请选择生日—日');
	 document.form1.de_name.focus();
	 return false;
