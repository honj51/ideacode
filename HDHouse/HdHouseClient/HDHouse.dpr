...
uses
  ...
  CnDebug in 'C:\Program Files\Borland\Delphi7\Experts\CnWizards\Source\CnDebug.pas',
  UMortgageCalculatorForm in 'UMortgageCalculatorForm.pas' {MortgageCalculatorForm},
  UCommentForm in 'UCommentForm.pas' {CommentForm},
  UNewsForm in 'UNewsForm.pas' {NewsForm},
  UPlanForm in 'UPlanForm.pas' {PlanForm},
  UWorkSummaryForm in 'UWorkSummaryForm.pas' {WorkSummaryForm},
  UMessageForm in 'UMessageForm.pas' {MessageForm},
  UMessageSettingForm in 'UMessageSettingForm.pas' {MessageSettingForm},
  URecipientsForm in 'URecipientsForm.pas' {RecipientsForm},
  USummaryForm in 'USummaryForm.pas' {SummaryForm},
  UCommentSettingForm in 'UCommentSettingForm.pas' {CommentSettingForm},
  UPlanSettingForm in 'UPlanSettingForm.pas' {PlanSettingForm},
  UNewsInfoForm in 'UNewsInfoForm.pas' {NewsInfoForm},
  UCityForm in 'UCityForm.pas' {CityForm},
  UAreaForm in 'UAreaForm.pas' {AreaForm},
  UUniteAreaForm in 'UUniteAreaForm.pas' {UniteAreaForm},
  UEstateDictionaryForm in 'UEstateDictionaryForm.pas' {EstateDictionaryForm},
  UEstateDictionaryInfoForm in 'UEstateDictionaryInfoForm.pas' {EstateDictionaryInfoForm},
  UMessageReplyForm in 'UMessageReplyForm.pas' {MessageReplyForm},
  UElectronicAttendanceInfo in 'UElectronicAttendanceInfo.pas' {ElectronicAttendanceInof},
  UElectronicAttendance in 'UElectronicAttendance.pas' {ElectronicAttendance},
  URecycleBin in 'URecycleBin.pas' {RecycleBin},
  UBusinessQAInfo in 'UBusinessQAInfo.pas' {BusinessQAInfo},
  UBusinessQA in 'UBusinessQA.pas' {BusinessQA};
