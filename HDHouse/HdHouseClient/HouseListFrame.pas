...
begin
   ...
   begin
    ...
    //建成年份
      ...
      sql:=sql+' and (';
    //物业名称
      sql:=sql+'(khzy_wymc=''无'' or khzy_wymc=''不限'' or khzy_wymc='''+qryHouseList.FieldByName('fczy_wymc').Text+''' ) and ';
    //物业用途
      sql:=sql+'(khzy_wyyt=''无'' or khzy_wyyt=''不限'' or khzy_wyyt='''+qryHouseList.FieldByName('fczy_wyyt').Text+''' ) and ';
    //物业类别
      sql:=sql+'(khzy_wylb=''无'' or khzy_wylb=''不限'' or khzy_wylb='''+qryHouseList.FieldByName('fczy_wylb').Text+''' ) and ';
    //所属区域
      sql:=sql+'(khzy_qy=''无'' or khzy_qy=''不限'' or khzy_qy='''+qryHouseList.FieldByName('fczy_qy').Text+''' ) and ';
    //装修程度
      sql:=sql+'(khzy_zxcd=''无'' or khzy_zxcd=''不限'' or khzy_zxcd='''+qryHouseList.FieldByName('fczy_zxcd').Text+''' ) and ';
    //具体地址
      sql:=sql+'(khzy_jtdz=''无'' or khzy_jtdz=''不限'' or khzy_jtdz like ''%'+qryHouseList.FieldByName('fczy_jtdz').Text+'%'' )';
      sql:=sql+' )';
