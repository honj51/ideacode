object CustomerListView: TCustomerListView
  Left = 0
  Top = 0
  Width = 976
  Height = 249
  ...
  object bsknpnl1: TbsSkinPanel
    ...
    object btn2: TbsSkinButton
      ...
      Down = False
      GroupIndex = 0
      Caption = #39640#32423#26597#35810'(&F)'
      NumGlyphs = 1
      Spacing = 1
    end
    object bsknchckrdbx2: TbsSkinCheckRadioBox
      ...
      Checked = False
      GroupIndex = 1
      Caption = #21482#26174#31034#27714#31199#20449#24687
    end
    object bsknchckrdbx1: TbsSkinCheckRadioBox
      ...
      Checked = False
      GroupIndex = 1
      Caption = #21482#26174#31034#27714#36141#20449#24687
    end
  ...
  object bsknpnl2: TbsSkinPanel
    ...
    object bskndbgrd1: TbsSkinDBGrid
      ...
      HScrollBar = bsknscrlbrCustomerDown
      VScrollBar = bsknscrlbrCustomerRight
    ...
    object bsknscrlbrCustomerDown: TbsSkinScrollBar
      Left = 1
      Top = 186
      Width = 974
      Height = 19
    ...
    object bsknscrlbrCustomerRight: TbsSkinScrollBar
      Left = 956
      Top = 1
      Width = 19
      Height = 185
