...
<%--            <form id="mainForm" runat="server">
    ...
    <script type="text/javascript">
			document.write('<a href="javascript://" onclick="openChat();"><img id="_imgLC" src="http://localhost/LiveChatService/ProcessImage.ashx?aid=4&referrer=' + document.referrer + '" border="0" alt="点击在线交谈" /></a>');
            </script>
            <h3>
                客服座席软件下载
            </h3>
