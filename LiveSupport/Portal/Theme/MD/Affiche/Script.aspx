...
<ItemTemplate>
sAnnounce += '<a style="<%#Eval("TitleColor") %><%#Eval("TitleFontFace") %>" href="<%=LeeHom.Cms.BLL.Config.Site.Url + LeeHom.Utility.ApplicationInfo.WebPath %>Affiche/<%#Eval("ID") %>.aspx" rel="external"><%# LeeHom.Utility.Text.StringOperate.CutString(Eval("IDName").ToString(),Word) %></a>　[<%#Eval("PostTime")%>]<br />';
</ItemTemplate>
</LeeHom:LHRepeater>
