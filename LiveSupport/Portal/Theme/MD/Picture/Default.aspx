<%@ Page Language="C#" MasterPageFile="~/Theme/MD/Master/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LeeHom.Cms.Web.BasePage.Picture.Default" %>
...
<div class="page">
<div class="title"><img src="../Theme/MD/Page/Sort.gif" /><asp:Literal runat="server" ID="IDName" Text="图片中心" /></div>
<div class="border">
<div id="PicList">
