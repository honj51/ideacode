<%@ Page Language="C#" MasterPageFile="~/Theme/SXZX/Master/Default.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LeeHom.Cms.Web.BasePage.Guestbook.Default" %>
...
昵称：<%#Eval("Poster")%><br />
性别：<%#Eval("Sex")%><br />
ＱＱ：<%#string.IsNullOrEmpty(Eval("QQ").ToString()) ? "保密" : ("<a href=\"tencent://message/?uin=" + Eval("PersonWeb") + "&site=" + LeeHom.Cms.BLL.Config.Site.Name + "&menu=yes\" rel=\"external\">" + Eval("QQ") + "</a>")%><br />
...
<%#string.IsNullOrEmpty(Eval("Replays").ToString()) ? "" : ("<div class=\"replay\">管理员[" + Eval("Replayer") + "]回复：<hr />" + Eval("Replays") + "</div>")%>
</td>
</tr>
</table>
</ItemTemplate>
