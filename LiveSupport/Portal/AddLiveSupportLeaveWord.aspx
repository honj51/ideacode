<%@ Page Language="C#" MasterPageFile="~/PortalMasterPage.master"  ValidateRequest="false" AutoEventWireup="true" CodeFile="AddLiveSupportLeaveWord.aspx.cs" Inherits="AddLiveSupportLeaveWord" Title="无标题页" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table align="center"  cellSpacing=1 cellPadding=0 width="785px" bgColor=#d2dfe6 
            border=0>
 <tr><td class="style1" bgColor=#f3f7fa align=left><a href="LiveSupportLeaveWord.aspx">返回留言板主页</a></td><td bgColor=#f3f7fa colspan="2" align=left>
            ...
            <tr><td align="right" bgColor=#f3f7fa>表情：</td><td colspan="2" align=left bgColor=#f3f7fa>
            ...
            <tr><td align="right" bgColor=#ffffff>留言内容：</td><td colspan="2" align=left bgColor=#ffffff>

                <FCKeditorV2:FCKeditor ID="FCKeditor1" runat="server" BasePath="FCKeditor/" ToolbarSet="Basic">
                </FCKeditorV2:FCKeditor>
                </td></tr>
            <tr><td bgColor=#f3f7fa></td><td colspan="2" align=left bgColor=#f3f7fa>
