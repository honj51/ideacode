/// <reference path="jquery-1.2.6-vsdoc.js" />
    ...
    LCS_invite_div.style.background = 'url(' + LCS_inviteImageUrl + '/invite_bg' + LCS_invitePanelStyle + '.gif)';
    LCS_invite_div.innerHTML = '<div style=" padding:8px 0px 0px 10px; color:#FFF; font-size:14px; height:20px;" >欢迎您来到'+LCS_companyName+'</div><div style="font-size:15px; padding:20px 0px 0px 145px; height:75px;" >亲爱的朋友您好！<br /><br />来到'+LCS_companyName+'有什么可以帮您的吗？</div><div  style=" padding:0px 0px 0px 230px;"><a href="#"  onclick="javascript:acceptInvitation();"><img src="' + LCS_inviteImageUrl + '/btn_ok' + LCS_invitePanelStyle + '.jpg" style="border:0px;"  /></a>&nbsp;&nbsp;&nbsp;<a href="#"  onclick="javascript:declineInvititation();" ><img src="' + LCS_inviteImageUrl + '/btn_no' + LCS_invitePanelStyle + '.jpg" style="border:0px;"/></a></div>';
    function invitetime() {
